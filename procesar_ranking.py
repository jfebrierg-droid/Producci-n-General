...
# Lista maestra con TODOS los miembros del equipo MEGAPODEROSOS (Eddy Concepcion sin acento)
...
def procesar_y_enviar():
    ...
    msg["Subject"] = (
        f"Reporte de Producción de {mes_actual.capitalize()} - MEGAPODEROSOS"
    )
