...
import schedule  # <-- Librería para la programación de tareas
...
if __name__ == "__main__":
    # Programar la ejecución para los lunes, miércoles y viernes a las 9:00 AM
    schedule.every().monday.at("09:00").do(procesar_y_enviar)
    schedule.every().wednesday.at("09:00").do(procesar_y_enviar)
    schedule.every().friday.at("09:00").do(procesar_y_enviar)

    print("Script programado. Ejecutándose automáticamente lunes, miércoles y viernes a las 9:00 AM...")
